...
public class Pismo extends Písmo
{
	public Pismo(Font font) { super(font); }
	public Pismo(Map<? extends AttributedCharacterIterator.Attribute, ?> attributes)
	{ super(attributes); }
	public Pismo(String názov, int štýl, double veľkosť)
