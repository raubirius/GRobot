...
public class Tlacidlo extends Tlačidlo
{
	public Tlacidlo(String text) { super(text); }
	public Tlacidlo(Obrazok obrázok) { super(obrázok); }

	public Tlacidlo(Obrazok obrázok, Obrazok obrázokStlačeného)
	{ super(obrázok, obrázokStlačeného); }

	public Tlacidlo(Obrazok obrázok, String text) { super(obrázok, text); }
}
