...
/** <p><a class="alias"></a> Alias pre {@link Archív Archív}.</p> */
public class Archiv extends Archív
{
	public Archiv() { super(); }
	public Archiv(String názov) { super(názov); }
	public Archiv(String cesta, String názov) { super(cesta, názov); }
}
