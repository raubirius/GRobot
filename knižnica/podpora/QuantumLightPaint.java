...
// a slúži na generovanie svetelného náteru tvoreného „kvantovými“ svetlami
// čo je pomenovanie vychádzajúce z dvoch skutočností. Prvou je, že na výpočty
// je používaná len celočíselná aritmetika (čo je v podstate „kvantová“ alebo
// „kvantovaná“ aritmetika) a druhou je, že správanie svetelných zdrojov nie
// je pri ich mixovaní úplne intuitívne, podobne ako nie je intuitívne správanie
// častíc v kvantovej mechanike. Licencia a zdroje sú uvedené nižšie v anglickom
// jazyku.
// 
 ...
 * a nice quantum (literally and behaviorally) light pattern. Literally,
 * because all computations are integer (quantized) and behaviorally,
 * because the lights (the pattern) behaves a little bit
 ...
 * @exclude
 */
public class QuantumLightPaint extends AbstractLightPaint
{
	/**
	 * <p>The paint context of the {@link QuantumLightPaint
	 * QuantumLightPaint} class.</p>
	 * 
	 * @see PaintContext
	 */
	public class QuantumLightPaintContext extends AbstractLightPaintContext
	{
		/**
	...
	/**
	 * <p>Creates and returns the {@link QuantumLightPaintContext
	 * QuantumLightPaintContext} instance that will be used to
	 ...
	 * @return the {@linkplain QuantumLightPaintContext arbitrary
	...
	{ return new QuantumLightPaintContext(); }
}
