...
/** <p><a class="alias"></a> Alias pre {@link PoznámkovýBlok PoznámkovýBlok}.</p> */
@SuppressWarnings("serial")
public class PoznamkovyBlok extends PoznámkovýBlok
{
	public PoznamkovyBlok() { super(); }
	public PoznamkovyBlok(String text) { super(text); }
	public PoznamkovyBlok(String text, boolean úpravy)
	{ super(text, úpravy); }
}
